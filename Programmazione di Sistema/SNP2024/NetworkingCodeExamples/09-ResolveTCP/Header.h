...
#define PORTNUMBER_OLD 		49152 		/**< TCP listening port, decimal */
#define SERVICEPORT_OLD 	"49152" 	/**< TCP listening port, name */
#define PORTNUMBER 		49236 		/**< TCP listening port, decimal */
#define SERVICEPORT 	"49236" 	/**< TCP listening port, name */
