...
Server waits 3 secs before sending the last empty datagram.
Client waits 2 second (the SO_RCVTIMEO), goes in time-out and start recv again.
This time it gets the empty datagram and closes.
Try setting SO_RCVTIMEO to 10 (no time-out then).
*/
